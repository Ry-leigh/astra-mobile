...
export const toastConfig = {
  success: ({ text1, text2 }) => (
    <View className="w-[90%] bg-emerald-50 border border-emerald-100 p-4 rounded-2xl flex-row items-center">
  ...
  error: ({ text1, text2 }) => (
    <View className="w-[90%] bg-rose-50 border border-rose-100 p-4 rounded-2xl flex-row items-center">
  ...
  info: ({ text1, text2 }) => (
    <View className="w-[90%] bg-blue-50 border border-blue-100 p-4 rounded-2xl flex-row items-center">
